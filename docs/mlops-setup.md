...
git add README.md docs .gitignore text2sql_rag_app/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[text2sql_rag_app/databricks.yml](../text2sql_rag_app/databricks.yml) file.
...
Follow the instructions in [text2sql_rag_app/resources/README.md](../text2sql_rag_app/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../text2sql_rag_app/resources/README.md)  to propose, test, and deploy
