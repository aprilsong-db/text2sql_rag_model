...
# ``text2sql_rag_app/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-text2sql_rag_app-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.llms.text2sql_rag_app-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.llms.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.llms.trip_dropoff_features",
